...
export class ERC1155Burnable extends ethereum.SmartContract {
  static bind(address: Address): ERC1155Burnable {
    return new ERC1155Burnable("ERC1155Burnable", address);
  }
